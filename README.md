...
A simple social web app developped, and used, by me and my friends. Built with:
```java
asp.net mvc + webapi + entity framework + sqlserver + angular.js + twitter's bootstrap + etc
```
